                    ...
                    <div key={flight._id} className="card hover:shadow-medium transition-all group">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button className="p-2 hover:bg-blue-50 text-blue-500 rounded-lg transition-colors">
                                    <Edit2 size={18} />
                                </button>
                                <button
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="text-center flex-1">
                                <div className="text-2xl font-bold text-secondary">{flight.origin.split('(').last.replace(')', '')}</div>
                                <div className="text-xs text-gray-400">{flight.origin.split('(').first.trim()}</div>
                            </div>
                            ...
                            <div className="text-center flex-1">
                                <div className="text-2xl font-bold text-secondary">{flight.destination.split('(').last.replace(')', '')}</div>
                                <div className="text-xs text-gray-400">{flight.destination.split('(').first.trim()}</div>
                            </div>
                        </div>
