        ...
        <div className="flex min-h-screen bg-background">
            ...
            <aside className="w-64 bg-white shadow-soft flex flex-col fixed h-full">
                ...
                <nav className="flex-1 mt-4">
                    ...
                    <button
                        onClick={logout}
                        className="flex items-center gap-3 text-gray-500 hover:text-red-500 transition-colors w-full px-6 py-4"
                    >
                        <LogOut size={20} />
                        <span>Logout</span>
                    </button>
            ...
            <main className="flex-1 ml-64">
                ...
                <header className="bg-white h-20 px-8 flex items-center justify-between sticky top-0 z-10 shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/flights" className="p-2 bg-primary text-white rounded-xl hover:bg-primary/90 transition-colors shadow-soft" title="Quick Add Flight">
                            <Plus size={20} />
                        </Link>
                    </div>
